...
Weikun Lin, Yunhao Bai, **Yan Wang**. <font color='Navy'>RPG-SAM: Reliability-Weighted Prototypes and Geometric Adaptive Threshold Selection for Training-Free One-Shot Polyp Segmentation</font>. **International Conference on Medical Image Computing and Computer Assisted Intervention (MICCAI)**, 2026. 

Zheng Lu, Peng Yu, **Yan Wang**. <font color='Navy'>Cycle-Veriffed Gentle Teaching and Confusion Correction for Label-Scarce Cross-Modal Single-Cell Annotation</font>. **International Conference on Medical Image Computing and Computer Assisted Intervention (MICCAI)**, 2026. 
